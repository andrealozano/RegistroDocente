...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                || SeguridadPreferenceFragment.class.getName().equals(fragmentName)
    ...
    public static class SeguridadPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_seguridad);
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("pref_seguridad_usuario"));
            bindPreferenceSummaryToValue(findPreference("pref_seguridad_usuario"));
        }
